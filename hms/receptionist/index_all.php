...
<body>
	...
	<div class="container-fluid">
			<div class="row">
				...
				<h4 class="text-center">All Patients List</h4>
        ...
        $total_pages = ceil($total_rows / $no_of_records_per_page);
				...
				$tb_header = "All Patients List";
				$query = "SELECT * FROM tblpatient ORDER BY date_reg DESC LIMIT $offset, $no_of_records_per_page";
