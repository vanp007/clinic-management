...
if (isset($_POST['apply'])) {
	...
	if(count($error) == 0){
		...
		$query = "INSERT INTO tbldoctor(firstname, surname, username, email, gender, phone, country, password, role, data_reg, status,profile) VALUES('$firstname','$surname','$username','$email','$gender','$phone','$country','$password','1',NOW(),'Approved','doctor.jpg')";


		$result = mysqli_query($connect,$query);

		if ($result) {
			echo "<script>alert('Doctor Registered Seccessfully')</script>";
